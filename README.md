...
A high-performance, from-scratch implementation of a TCP packet reassembly engine. This project demonstrates how to track, capture and reconstruct the fragmented network streams efficiently using low-level memory layouts and optimized hashing technique.
